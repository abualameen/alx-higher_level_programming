#!/usr/bin/python3
"""
This module defines a singly linked list using class of the object oriented programming
...
class Node:
    ...
    def __init__(self, data, next_node=None):
        """
        This function initializes the attributs of the node of a singly linked list
        Args:
    ...
    def data(self, value):
        ...
        Args:
            value (int): this is the value that represents the data stored inthe node
        Raises:
    ...
    def next_node(self, value):
        ...
        Args:
            value (Node): this is the value that represents the next node pointer
        Raises:
